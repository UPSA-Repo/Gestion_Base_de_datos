create database Exam2Verif
go

use Exam2Verif

/*1. Para el problema y DER descritos, escribir el c�digo SQL necesario para crear la BD y sus tablas.
Deber� contemplar las transformaciones necesarias al modelo l�gico, las restricciones necesarias, y el orden correcto de creaci�n.*/
